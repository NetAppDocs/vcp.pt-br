...
* <<error_vcp48_67u1,Erros após a atualização do plug-in do NetApp Element para VMware vCenter Server 4,8 ou posterior com o VMware vCenter Server 6.7U1>>
...
SIOC is not enabled
----
. Consulte  https://kb.netapp.com/on-prem/solidfire/Element_OS_Kbs/mNode_Status_Network_Down_or_Down_in_the_mNode_Settings_tab_of_Element_Plugin_for_vCenter_VCP["este artigo"] para obter informações sobre a ação corretiva específica para o seu problema.
