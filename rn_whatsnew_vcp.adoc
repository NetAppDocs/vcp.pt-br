...
[role="lead"]
O NetApp Element Plug-in para a versão vCenter Server 5.5 oferece melhorias de segurança e está disponível com a versão 2.27.40 dos serviços de gerenciamento.

link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["Saiba mais sobre o lançamento do Element Plug-in para vCenter Server 5.5"^]



== Plug-in NetApp Element para vCenter Server 5.4

O plug-in Element vCenter 5.4 está disponível com a versão 2.26.30 dos serviços de gerenciamento.

link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676["Saiba mais sobre o lançamento do Element Plug-in para vCenter Server 5.4"^]



== Plug-in do NetApp Element para vCenter Server 5,3

O NetApp Element Plug-in para vCenter Server 5.3 oferece melhorias de segurança e desempenho.

https://library.netapp.com/ecm/ecm_download_file/ECMLP3316480["Saiba mais sobre o lançamento do Element Plug-in para vCenter Server 5.3"^] .
