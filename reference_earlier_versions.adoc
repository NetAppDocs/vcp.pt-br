...
[role="lead"]
A documentação também está disponível para versões anteriores à versão 5.5 do NetApp Element Plug-in para VMware vCenter Server.


NOTE: Esselink:index.html["link de documentação"] O plug-in Element vCenter 5.5 também inclui as versões 5.4, 5.3, 5.2, 5.1, 5.0, 4.10, 4.9, 4.8, 4.7 e 4.6.
