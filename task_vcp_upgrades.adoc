...
[role="lead"]
Você pode atualizar o NetApp Element Plug-in para vCenter Server seguindo as etapas descritas para sua instalação.  O plug-in NetApp Element vCenter 5.5 está disponível fora das versões Element e NetApp HCI como parte de um pacote de serviços de gerenciamento.
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["Notas de versão do plug-in NetApp Element vCenter 5.5"^]
...
* https://docs.netapp.com/us-en/element-software/index.html["Recursos de documentação do SolidFire e do Element"^]
